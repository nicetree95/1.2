...
--и не поняла, надо было оставлять указанные для формы поля (в конце строки комменты) или надо было заменить на англ сокращения с _ по условиям задачи. или это было только про первую таблицу)
